...
public class FloorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        floorViewModel =
                new ViewModelProvider(this).get(FloorViewModel.class);

        binding = FragmentFloorBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textFloor;
        floorViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
